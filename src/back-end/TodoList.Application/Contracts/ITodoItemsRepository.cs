...
namespace TodoList.Application.Contracts
{
    ...
    {
        Task<TodoItem> CreateTodoItem(TodoItem todoItem, CancellationToken cancellationToken);

        Task<bool> FindDuplicateTodoItem(Expression<Func<TodoItem, bool>> expression, CancellationToken cancellationToken);
